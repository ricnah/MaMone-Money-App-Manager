...
export class NewInstall extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount() {
      ...
      handleSelesai = async () => {
        ...
        try {
          ...
          this.props.navigation.navigate('Bisnis');
        } catch (error) {
        ...
        return (
            ...
            <SafeAreaView style={{flex:1, backgroundColor:'#D3F4D6'}}>
                ...
                <View style={{flex:1}}>
                    ...
                    <Image source={imageProfile == ''? require("./image/profil1.jpg") : {uri : imageProfile}} style={{ height: 200, width: 200, borderRadius: 100, borderWidth: 2, borderColor: '#3B9F45' }} />
                    ...
                    <View style={[styles.menuContainer, {marginTop:30, position:'relative', alignItems:'center'}]}>
                        ...
                        onPress={this.handleSelesai}>
                            <View>
                                <Text style={{fontSize:20, fontFamily:'Manrope', fontWeight:'bold', color:'#fff'}}>Lanjutkan</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
